...
export async function up({ db }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TABLE "payload_mcp_api_keys" (
  	...
  	"open_source_find" boolean DEFAULT false,
  	"open_source_create" boolean DEFAULT false,
  	"open_source_update" boolean DEFAULT false,
  	"post_categories_find" boolean DEFAULT false,
  	"media_find" boolean DEFAULT false,
  	"cv_find" boolean DEFAULT false,
  	"cv_update" boolean DEFAULT false,
